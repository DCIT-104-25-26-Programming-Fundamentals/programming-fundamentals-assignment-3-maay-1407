...
/**
 * Feature 2: Displays all current tasks numbered from 1, or a friendly message if empty.
 */
function viewTasks() {
    console.log('\nYour Tasks:');
    if (tasks.length === 0) {
...
/**
 * Feature 3: Displays tasks, prompts for a task number to delete, and removes it safely.
 */
function deleteTask() {
    if (tasks.length === 0) {
    ...
    // Validate index (1-based user input convert to 0-based index)
    ...
    while (running) {
        ...
        switch (choice) {
            ...
            case '4':
                ...
                break;
            default:
                console.log('Invalid choice! Please select a option between 1 and 4.');
                break;
        }
    }
}
